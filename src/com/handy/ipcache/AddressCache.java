 ...
 * 
 * The goal is to write the most beautiful and functionally correct code
 * possible (including proof of correctness - i.e. tests).
 * 
 * Please mention the asymptotic complexity (Big-Oh) for each method of your
 * implementation.
 * 
 * offer() - Adds an element and returns true on success. An element can exist
 * only once in the cache and consecutive offers move the element to the front
 * of the list.
 * 
 ...
 * 
 * peek() - Returns the most recently added element or null if the cache is
 * empty
 * 
 * remove() - Retrieves and removes the most recently added element or null of
 * the cache is empty
 * 
 * take() - Retrieves and removes the most recently added element, waiting if
...
public interface AddressCache {
	...
	/**
	 * Returns {@code true} if the given {@link InetAddress} is in the
	 * {@link AddressCache}.
	 */
	public boolean contains(InetAddress address);

	/**
	 * Removes the given {@link InetAddress} and returns {@code true} on
	 * success.
	 */
